...
function Table:open_in_scim(add_link)
	local _, table_top_line, table_bottom_line, file_lines, sc_sheet_name, sc_file_path, sc_link_fmt =
		U.get_table_under_cursor()
...
function Table:show_changes()
	local table_found, table_top_line, table_bottom_line, file_lines, sc_sheet_name, sc_file_path, sc_link_fmt =
		U.get_table_under_cursor()
